...
|--------|------|-----------|----------|--------------|
| actions_to_first_craft (v1) | 7.000 | ±0 | niedriger | Aktionen bis zum ersten erfolgreichen Craft (naiv) |
...
| skill_spread (v1) | 0.198 | ±0 | niedriger | Überlebens-Spanne optimal vs. zufällig (fallend = gehobene Einsteiger-Decke) |
...
| warmth_stability (v1) (Probe bis 27.08.) | 0.720 | ±0 | im Band | Anteil Kälte-Stress-Ticks, die warm überstanden werden (Feuer/Isolation) |
