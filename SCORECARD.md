...
|--------|------|-----------|----------|--------------|
| actions_to_first_craft (v1) | 7.000 | -2.500 ↑ besser | niedriger | Aktionen bis zum ersten erfolgreichen Craft (naiv) |
...
| skill_spread (v1) | 0.198 | -0.004 ↑ besser | niedriger | Überlebens-Spanne optimal vs. zufällig (fallend = gehobene Einsteiger-Decke) |
...
| session_depth (v2) (Probe bis 08.09.) | 52.500 | -10.500 ↓ schlechter | höher | Aktionen bis nichts Neues passiert (ziel-bewusster naiver Bot, v2) |
| discovery_gap (v1) | 0.545 | -0.055 | im Band | Abstand erreichbar vs. tatsächlich gefunden |
